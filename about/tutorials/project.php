...
<html>
	<head>
		<title>Chico State Web Development Club - Project</title>
		<meta charset="UTF-8">
	...
	<body>
		<div id="wrap">
			...
			<section id="body">
				<h1 id="bodyHeader">Portfolio Website</h1>
				<div id="contentContainer">
					
					<div id="bodyPost" class="BodyContent">
						<h3 style="text-align: left; padding-left: 10px; font-size: 190%;">Project Milestones</h3>
							<ul class="Tutorial">
								<li><a href="draft.php">Drafting your website</a></li>
								<li><a href="basichtml.php">Basic HTML</a></li>
								<li><a href="basiccss.php">Adding some style with CSS</a></li>
								<li><a href="websiteskeleton.php">Website skeleton</a></li>
								<li><a>Adding a form</a></li>
								<li><a>Your first PHP Script</a></li>
								<li><a>Javascript validation</a></li>
								<li><a>Adding more PHP</a></li>
								<li><a>Jquery</a></li>
								<li><a>Filling in content</a></li>
								<li><a>Website Presentation</a></li>
							</ul>
					</div>
				</div>
			</section>
		<footer>			
			...
			<span class="Login">	
				...
				<span class="Login">Logged in as <?php echo htmlentities($_SESSION['username']); ?>!</span>
			</span>
